...
| [0010](0010-runtime-observability-egress-verification.md) | Runtime observability egress verification — enforcing secret-freedom where the only plaintext secret exists | Draft |
