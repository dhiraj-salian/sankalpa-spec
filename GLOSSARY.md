...
- **Bootstrap-seated reviewer** — A Reviewer or Domain Lead seated **solely** by the founding maintainer's Bootstrap Authority, with no endorsement from an already-independent party. Marked as such in [`MAINTAINERS.md`](MAINTAINERS.md); such reviewers alone cannot clear an Interim-Acceptance Ledger entry or satisfy the v1.0 two-independent-reviewer gate. (RFC-0012 §4.5)
- **Staffing-status note** — The dated note the founding maintainer MUST publish in the Interim-Acceptance Ledger at least every 90 days while Bootstrap Authority is in force, recording which domains remain unstaffed and what recruitment was attempted. A gap in the record is a visible governance lapse. (RFC-0012 §4.6)
